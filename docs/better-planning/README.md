...
| `features/harness/harness-tasks.md` | tasks | **ready** 2026-06-08, **amended 2026-06-09 ×2** — 29 tasks (T1–T29), one PR per milestone; exported to GitHub issues #6–#31 + T27–T29, label `auto-tasks`; soundness amendments folded into T2/T11/T12/T24/T27–T29; next: build T1 (#6) |
