...
| `features/code-review/code-review-prd.md` | prd | **settled 2026-06-19** — Phase 3 feature PRD (+ overview.html). Composite specialists → agreement-based verify (harness #35) → constrained coordinator; eval-harness-first build order. All open decisions resolved via canvas review round 1. Next: implementation plan (better-planning-plan) |
